...
# readme has the same information as what you 
...
de_duped_uids <- neonOS::removeDups(data=inv_fieldData,
                             variables=variables_20120,
                             table='inv_fieldData') #added code chunk 10/30/22
...
# can also join tables using neonOS::joinTableNEON
