...
bathymetryData <- neonUtilities::zipsByURI(filepath = bathymetryList,
                                           savepath = "~/GitHub/WORKSHOP-GLEON-NEON-2022",
                                           check.size = FALSE)

# Read in most recent bathymetry metrics table
bathyVolMetrics <- read.csv("~/GitHub/WORKSHOP-GLEON-NEON-2022/NEON_D05_LIRO_20200730_BATHYMETRY_L4_VA/D05LIRO_BATH_20200730_volume.csv")
surfaceAreaMetersSq <- bathyVolMetrics$X2d_area[bathyVolMetrics$Depth == 0]

bathyDepthMetrics <- read.csv("~/GitHub/WORKSHOP-GLEON-NEON-2022/NEON_D05_LIRO_20200730_BATHYMETRY_L4_VA/D05LIRO_BATH_20200730_tracks.csv")
